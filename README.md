...
GitHub Actions で `main` への push 時に GitHub Pages へデプロイします。Pages の source は GitHub リポジトリ設定で **GitHub Actions** を選択してください。新しい visualizer を公開対象にする場合は、ワークフローと公開ページのリンク一覧も更新します。
